...
def handle_dry_run(event):
    ...
    local_path, _ = generate_report(findings, format_type=report_format, local_mode=True)
    ...
    return {
        ...
        "body": {
            ...
            "narrative_summary": (
                mock_narrative[:500] + "..." if len(mock_narrative) > 500 else mock_narrative
            ),
        },
    }
...
def lambda_handler(event, context):
    ...
    print(f"AWS Request ID: {context.request_id if hasattr(context, 'request_id') else 'N/A'}")
